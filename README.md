...
* [ARM9/bass](https://github.com/ARM9/bass) - A fork of byuu's bass assembler which has been updated with Nintendo 64 MIPS/RSP/RDP output
...
* [Kaizen (previously Gadolinium)](https://github.com/mehmetpeker1/Kaizen) - Work-in-progress emulator written in C++, able to already play some commercial games and replay Mupen TAS movies
...
* [N64cart](https://github.com/pdaxrom/N64cart) - A flash cartridge based on the RP2040 microcontroller
...
* [Body Harvest](https://github.com/jaytheham/body-harvest-decompilation) - An in-progress decompilation of _Body Harvest_ in D (see also [DeltaniumIndustries/BodyHarvestDecomp](https://github.com/DeltaniumIndustries/BodyHarvestDecomp))
...
* [Sharkwire 64](https://github.com/Jhynjhiruu/sharkwire) - An in-progress decompilation of the SharkWire Online cartridge firmware
...
* [Legend of Elya](https://github.com/Scottcjn/legend-of-elya-n64) - A Zelda-style ROM running a real transformer for live LLM inference powering an NPC, built with `libdragon`
