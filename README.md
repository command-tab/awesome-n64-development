...
* [Legend of Elya](https://github.com/Scottcjn/legend-of-elya-n64) - A Zelda-style ROM running a transformer for live LLM inference powering an NPC, built with `libdragon`
